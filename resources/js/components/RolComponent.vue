          ...
          <div class="card">
              ...
              <div class="card-body">
                  <div class="form-group row">
                      <div class="col-md-6">
                          <div class="input-group">
                              ...
                              <input type="text" class="form-control" placeholder="Texto a buscar" v-model="buscar" @keyup.enter="listarRol(1,buscar,criterio)">
                  ...
                  <table class="table table-bordered table-striped table-sm">
                      ...
                      <tbody>
                          <tr v-for="rol in roles" :key="rol.uuid">
        ...
        methods: {
          listarRol(page,buscar,criterio){
            ...
            axios.get(url).then(function (response){
              me.roles = response.data.roles.data;
